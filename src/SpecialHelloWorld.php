...
namespace MediaWiki\Extension\DiscordAds;
...
class SpecialHelloWorld extends SpecialPage {
	...
	public function execute( $sub ) {
		...
		$out->setPageTitle( $this->msg( 'discordads-helloworld' ) );

		$out->addHelpLink( 'How to become a MediaWiki hacker' );

		$out->addWikiMsg( 'discordads-helloworld-intro' );
		...
		$config = MediaWikiServices::getInstance()->getConfigFactory()->makeConfig( 'discordads' );
		if ( $config->get( 'DiscordAdsEnableFoo' ) ) {
